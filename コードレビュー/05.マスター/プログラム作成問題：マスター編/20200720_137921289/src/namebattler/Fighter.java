...
public class Fighter extends Player {
	...
	public void Attack(Player atackplayer, Operation choiseoperation,
		...
		if (condition == 1) {
			...
			if (atackplayer.hp < atackplayer.Max_hp / 4
					&& atackplayer.finalatack == 1) {
				System.out.println(atackplayer.name + "は特技を使った！（相手プレイヤー：HP-100）");
				SinglefinalDamege(atackplayer,choosedefender);
