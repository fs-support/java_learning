...
public class PulanPhysicalPriority extends Operation{


	protected PulanPhysicalPriority() {
		MakeOperation();
		MakeMazic();
	}
	...
	protected void MakeOperation() {
		...
		this.operationNO = 3;
		// 作戦名
		this.operationName = "物理優先";
		// 作戦内容
		this.operationcontent = "通常攻撃を優先して行う";
		//魔法の使用有無
		this.OrNotmagic = 0;
	...
	//使用する魔法を選ぶ
	public Mazic Choosemagic(Player attackplayer,int trunNumber) {
