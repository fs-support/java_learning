...
public class GameManager {
	...
	public void Start() {
		...
		int pulanslistNO = 0;
		while(true){
			if(OperationList.pulansList.indexOf(OperationList.pulansList.get(INputchoiseOperation - 1)) == -1){
		...
		// 選んだ作戦を格納
		Operation choiseoperation = OperationList.pulansList.get(pulanslistNO);
