...
public class Player {
	...
	// 攻撃力
	protected int str;
	protected int defaultSTR;
	// 防御力
	protected int def;
	protected int defaultDEF;
	// 幸運
	protected int luck;
	protected int defaultLUCK;
	//速度
	protected int agi;
	protected int defaultAGI;
	// 麻痺
	...
	*/
	...
	public void PrintStatus() {
		...
		System.out.printf("%s (HP=%3d/%3d : MP=%3d/%3d : STR=%3d : DEF=%3d LUCK=%3d : AGI=%3d)\n", this.GetName(), this.hp,
				this.defaultHP,this.mp, this.defaultMP,this.defaultSTR, this.defaultDEF, this.defaultLUCK, this.defaultAGI);
	 ...
	 */
	public boolean Heal(Player ActivePlayer, ArrayList<Player> passiveParty) {
		// ジョブごとにオーバーライドして処理を記述してください
		return false;
	}
	/**
